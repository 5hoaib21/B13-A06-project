      ...
      <div className="getStartedContent space-y-8 py-10">
        <div className="flex flex-col items-center justify-center text-center">
          ...
          <h1 className="text-4xl font-bold  mb-5">
            Get Started with Digitools
          </h1>
          <p className="text-zinc-500 ">
            Ready to get started? Follow these simple steps to begin your
            journey with our platform.
          </p>
        </div>

        <div className="cardContainer grid grid-cols-1 md:grid-cols-3 gap-6 mt-8 ">
          <div className="relative  border border-gray-300 shadow-lg rounded-lg p-10  m-2 text-center items-center justify-center space-y-4 hover:shadow-2xl transition-shadow duration-300">
            <div
              className="absolute top-2 right-2 bg-blue-500 text-white font-bold
